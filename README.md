## simple_launch (rolling) - 1.11.4-1

The packages in the `simple_launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling simple_launch` on `Tue, 31 Mar 2026 07:29:36 -0000`
...
## simple_launch (jazzy) - 1.11.4-1

The packages in the `simple_launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --track jazzy simple_launch` on `Tue, 31 Mar 2026 07:26:02 -0000`
...
## simple_launch (rolling) - 1.11.3-1

The packages in the `simple_launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling simple_launch` on `Wed, 11 Feb 2026 11:45:41 -0000`
...
## simple_launch (rolling) - 1.11.2-1

The packages in the `simple_launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling simple_launch` on `Mon, 02 Feb 2026 09:46:16 -0000`
...
## simple_launch (rolling) - 1.11.1-1

The packages in the `simple_launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling simple_launch` on `Mon, 24 Nov 2025 18:57:58 -0000`
...
## simple_launch (jazzy) - 1.11.1-1

The packages in the `simple_launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --track jazzy simple_launch` on `Mon, 24 Nov 2025 18:54:41 -0000`
...
## simple_launch (humble) - 1.11.1-1

The packages in the `simple_launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble simple_launch` on `Fri, 21 Nov 2025 12:53:43 -0000`
...
## simple_launch (rolling) - 1.11.0-1

The packages in the `simple_launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling simple_launch` on `Sun, 16 Feb 2025 10:58:38 -0000`
...
The packages in the `simple_launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy --track jazzy simple_launch` on `Sun, 16 Feb 2025 10:56:13 -0000`
...
The packages in the `simple_launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble simple_launch` on `Sun, 16 Feb 2025 10:53:58 -0000`
...
## simple_launch (rolling) - 1.10.1-1
